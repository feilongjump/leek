<template>
  <div class="sidebar-container">
    ...
    <div>
      <!-- Logo -->
      <div class="h-9">
        <span class="text-gray-300 text-3xl">Leek</span>
      </div>
      <!-- Menu -->
      <div class="mt-8">
        ...
        <ul class="text-gray-300">
          <li v-for="(menu, index) in menus" :key="index">
            <router-link class="menu-li hover:activate-menu" :to="{ name: menu.routeName }">
              <component
                :is="menu.icon"
    ...
    <div class="h-16 mb-8 flex justify-center lg:justify-between items-center text-gray-400">
      ...
      <div class="mx-2 hidden lg:flex flex-col">
        <span class="text-white">Leek</span>
        <span class="text-sm">leek@example.com</span>
      </div>
...
const menus = [
  ...
  },
  {
    title: 'Stock',
    icon: ChartBarIcon,
    routeName: 'Backstage.Stock'
  },
  {
    title: 'Cash Book',
    icon: CashIcon,
    routeName: 'Backstage.CashBook'
  },
  {
    title: 'System',
    icon: CogIcon,
    routeName: 'Backstage.System'
  }
]
...
const logout = () => {
  Alert.success('Welcome to you next time!')
